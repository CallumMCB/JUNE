...
n = 2  # Number of nearest stations to find
max_distance = 5  # Maximum distance threshold in kilometers

def find_nearest_stations(df, tree, n=2, max_distance=5):
...
df_nearest_train_stations = find_nearest_stations(df_filtered_train_stations, train_station_tree)
df_nearest_um_stations = find_nearest_stations(df_filtered_um_stations, um_station_tree)
